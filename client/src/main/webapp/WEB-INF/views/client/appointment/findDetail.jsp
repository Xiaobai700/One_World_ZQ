                            ...
                            <div class="social-feed-box">
                                <div class="social-avatar">
                                    <a href="#" class="pull-left">
                                        <a href="personal.do?account=${comment.userInfo.account}"><img alt="image" src="head/${comment.userInfo.head }"></a>
                                    </a>
                                    <div class="media-body">
                                        <a href="#" style="float: left;">
                                                ${comment.userInfo.nickName }
                                        </a>
                                        <small class="text-muted" style="float: left;">${comment.job}行业</small>
                                    </div>
                                </div>
                                <div class="social-body">
                                    ...
                                    <div class="under_answer">
                                        ...
                                        <c:if test="${comment.replyNumbers > 0}">
                                            <a class="talk" onclick="getReply('查看对话','replyPage.do','${comment.comment.id}',3,'${appId}')"><i class="fa fa-comments"></i>查看对话</a>
                                        </c:if>
...
<script type="text/javascript">
    $(".reply").toggle(function () {
        ...
        $(".aa").live('click',function () {
            replyComment(account,commentId,3,'${appId}');
        });
